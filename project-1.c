...
int main (int argc, const char *argv[])
{
    ...
    //unsigned char ciphertxt[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	...
	while (fgets(key, MAX_LENGTH, fp) != NULL)
	{
		...
		printf(" The key is : %s\n The Corresponding Cipher Text Is: ", key);
		...
		if (matched == 1)
		{
            ...
            printf("The length of the ciphertxt: %d \n", outlen);
